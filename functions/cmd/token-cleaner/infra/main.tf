...
module "token_cleaner_schedule" {
  ...
  http_target = {
    uri         = "https://${var.region}-run.googleapis.com/apis/run.googleapis.com/v1/projects/${var.project_id}/locations/${var.region}/jobs/${module.token_cleaner_job.job_name}:run"
    http_method = "POST"
    oidc_token = {
