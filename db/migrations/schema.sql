...
CREATE TABLE routes (id TEXT PRIMARY KEY, source TEXT NOT NULL, source_id TEXT NOT NULL, source_url TEXT NOT NULL, geojson TEXT NOT NULL, distance_km REAL, distance_mi REAL, created_at TEXT NOT NULL DEFAULT (STRFTIME ('%Y-%m-%d %H:%M:%f', 'NOW')), UNIQUE (source, source_id));
